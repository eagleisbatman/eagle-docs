...
description: Create professional infrastructure and architecture documentation as HTML with brutalist styling. Includes system diagrams, cloud service configurations, cost estimates, monitoring setup, and disaster recovery plans. Outputs are desktop-optimized with one section per viewport. Use when user requests infrastructure documentation, architecture diagram, cloud setup guide, DevOps documentation, or deployment guide.
---
...
Creates professional infrastructure documentation as HTML files with brutalist black-and-white aesthetics. Each section occupies one viewport with scroll-based navigation. Optimized for desktop/laptop viewing (1024px+).
