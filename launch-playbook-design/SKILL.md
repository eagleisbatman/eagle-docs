...
description: Create professional launch playbook and go-to-market documentation as HTML with brutalist styling. Includes launch phases, checklists, success metrics, risk management, rollback procedures, and communication plans. Outputs are desktop-optimized with one section per viewport. Use when user requests launch plan, GTM strategy, launch playbook, release checklist, or go-live documentation.
---
...
Creates professional launch playbook documentation as HTML files with brutalist black-and-white aesthetics. Each section occupies one viewport with scroll-based navigation. Optimized for desktop/laptop viewing (1024px+).
